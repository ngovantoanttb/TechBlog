...
?>
<article class="group bg-white flex flex-col sm:flex-row gap-6 cursor-pointer transition-all duration-300 border-b border-slate-100/80 last:border-0 mb-6 last:mb-0">
    ...
    <div class="flex flex-col flex-grow min-w-0 pt-1 sm:pt-2 pr-0 sm:pr-4 md:pr-6">
