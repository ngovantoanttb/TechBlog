        ...
        <div class="col-span-12 lg:col-span-8 bg-white border border-slate-100/80 p-5 sm:p-8 premium-shadow">
            ...
            if ( have_posts() ) :
                while ( have_posts() ) : the_post();
                    ...
                    <!-- Rich Post Body -->
                    <div class="prose max-w-none text-slate-600 text-base sm:text-[14.5px] leading-relaxed space-y-6 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:my-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:my-4 [&_li]:my-1.5">
                        <?php
